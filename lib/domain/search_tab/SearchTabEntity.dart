class SearchTabResponseEntity {
  ...
  SearchTabResponseEntity.fromJson(dynamic json) {
    status = json['status'];
...
class DataSearchEntity {
  ...
  num? limit;
  num? pageNumber;
  List<MoviesSearchEntity>? movies;
