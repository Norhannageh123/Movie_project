                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Text(
                                    editeProfileViewModel.listOfFavMovie.length.toString(),
                                    style: AppStyle.white24BoldInter),
                                SizedBox(
                                  height: height * 0.02,
                                ),
                            ...
                            Column(
                              children: [
                                Text(
                                    editeProfileViewModel.movieHistoryList.length.toString(),
                                    style: AppStyle.white24BoldInter),
                                SizedBox(
                                  height: height * 0.02,
                                ),
                            ...
                            Row(
                              ...
                              children: [
                                Column(
                                  children: [
                                    Image(
                                        image: AssetImage(AppImages.watchListIcon)),
                                    SizedBox(
                                      height: height * 0.02,
                                    ),
                                    Text(
                                        '${AppLocalizations.of(context)!.watch} List',
                        ...
                        Expanded(
                          child: selectedIndex == 0
                              ? Center(
                                  child: editeProfileViewModel.listOfFavMovie.isEmpty
                                      ? Image.asset(
                                                ...
                                                Navigator.pushReplacementNamed(
                                                    ...
                                                    arguments: int.parse(
                                                        editeProfileViewModel
                                                            .listOfFavMovie[index]
                                                            .movieId!));
                                              },
                                              child: StackedImageAndRating(
                                                  imageUrl: editeProfileViewModel
                                                      .listOfFavMovie[index]
                                                      .imageURL,
                                                  rating: editeProfileViewModel
                                                      .listOfFavMovie[index]
                                                      .rating
                                                      .toString(),
                                                  onItemClicked: () =>
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              Text(
                                  editeProfileViewModel.listOfFavMovie.length
                                      .toString(),
                                  style: AppStyle.white24BoldInter),
                              SizedBox(
                                height: height * 0.02,
                            ...
                            children: [
                              Column(
                                children: [
                                  Image(
                                      image:
                                          AssetImage(AppImages.watchListIcon)),
                                  SizedBox(
                                    height: height * 0.02,
                                  ),
                                  Text(
                      ...
                      Expanded(
                        child: selectedIndex == 0
                            ? Center(
                                child: editeProfileViewModel
                                        .listOfFavMovie.isEmpty
                                    ? Image.asset(
                                        AppImages.searchImage,
                                        fit: BoxFit.cover,
                                      )
