  ...
  Widget drawBottomSheet(var height) {
    return Column(
      ...
      children: [
             ...
             Text(
                widget.title,
                style: widget.currentPage == 0 ?AppStyle.white30BoldInter:AppStyle.white24Bold,
                textAlign: TextAlign.center,
              ),
             Text(
                widget.desc ?? "",
                style:widget.currentPage == 0? AppStyle.lightWhite20Regular: AppStyle.white20Regular,
                textAlign: TextAlign.center,
             ),
        SizedBox(
          height: height * .01,
        ...
        widget.currentPage == 0
          ...
          paddingVertical: height*.01,
                ...
                onClickedButton: () {
                  widget.controller.nextPage(duration: Duration(milliseconds: 1000), curve: Curves.fastEaseInToSlowEaseOut);
                },
            ...
            : Column(
                ...
                children: [
                  ...
                  CustomElevatedButton(
                      ...
                      onClickedButton: () {
                        widget.controller.previousPage(duration: Duration(milliseconds: 1000), curve: Curves.fastEaseInToSlowEaseOut);
                      },
